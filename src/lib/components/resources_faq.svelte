<div class="flex-col flex items-center gap-[50px] h-fit mt-20">
  <div class="flex-col w-full flex items-start gap-[60px] rounded-[20px] max-w-[1060px]">
    ...
    <div class="w-full flex-col flex items-start gap-5">
      <div class="bg-white w-full flex items-start gap-[60px] p-10 rounded-[20px]">
        <div class="flex-1 flex-col flex items-start gap-6 text-[#2e3855]">
          <div class="w-full flex-col flex items-start gap-[18px]">
            <div class="w-full flex justify-end items-start gap-[18px]">
              <div class="h-full flex-1 flex-col flex items-start gap-[18px]">
                ...
                <div class="text-2xl leading-[33px] font-bold font-Poppins">
                ...
                <div class="text-md leading-[26px] font-light font-PublicSans w-full">
                  We have in-house expertise with a deep understanding of a variety of technologies and an extensive network of
                ...
                <div class="text-md leading-[26px] font-light font-PublicSans w-full">
                  Our advanced calculator tool is designed to provide you with a comprehensive understanding of your project's
                ...
                <div class="text-md leading-[26px] font-light font-PublicSans w-full">
                  We have a rigorous selection process that involves comprehensive due diligence, site visits, and performance
                ...
                <div class="text-md leading-[26px] font-light font-PublicSans w-full">
                  Absolutely. While our platform is optimised to find the best match for your specific needs, we present you
                ...
                <div class="text-md leading-[26px] font-light font-PublicSans w-full">
                  The timeline for project implementation can vary based on its complexity and scale. Smaller projects, such as
                ...
                <div class="text-md leading-[26px] font-light font-PublicSans w-full">
                  After you decide to proceed, we will facilitate the contract, oversee the implementation, and provide ongoing
                  support to ensure the project's success.
                </div>
                <div class="pt-10 text-md leading-[26px] font-light font-PublicSans w-full">
                  If you have any more questions, feel free to <a class='underline text-pfp-green'href="/contact">reach out to us</a>
