              ...
              <div class="flex-1 flex-col flex items-start gap-8">
                ...
                <a href="/explore">
                  <div
                    ...
                    <img
                      src="/assets/new/arrow-right-circle.svg"
                      alt="arrow-right-circle-31-CTA-31-Frame24-31-Frame24-31-Frame24-31-Frame18-31-Controlsupply-31-blockrow1-31-wrapper-31-03Greenenergy"
                      class="h-5 w-5" />
              ...
              <div class="h-full flex-1 flex-col flex items-start gap-8">
                ...
                <a href="/explore">
                  <div
                    ...
                    <img
                      src="/assets/new/arrow-right-circle.svg"
                      alt="arrow-right-circle-31-CTA-31-Frame24-31-Frame24-31-Frame24-31-Frame18-31-Savecosts-31-blockrow2-31-wrapper-31-03Greenenergy"
                      class="h-5 w-5" />
                    <div>Save money now</div>
                  </div>
                </a>
              </div>
              <img
              ...
              <div class="relative flex-1 flex-col flex items-start gap-8">
                ...
                <a href="/explore">
                  <div
                    ...
                    <img
                      src="/assets/new/arrow-right-circle.svg"
                      alt="arrow-right-circle-31-CTA-31-Frame24-31-Frame24-31-Frame24-31-Frame18-31-Controlfootprint-31-blockrow2-31-wrapper-31-03Greenenergy"
                      class="h-5 w-5" />
                    <div>Go green</div>
                  </div>
                </a>
            ...
            <div class="h-full flex-1 flex-col flex items-start gap-8">
              ...
              <a href="/explore">
                <div
                  ...
                  <img
                    src="/assets/new/arrow-right-circle.svg"
                    alt="arrow-right-circle-31-CTA-31-Frame24-31-Frame24-31-Frame24-31-Frame18-31-Ourcutting-edgetechnologymatchingservice-31-wrapper-31-03Greenenergy"
                    class="h-5 w-5" />
                  <div>Explore our tools now</div>
                </div>
              </a>
            </div>
          </div>
        </div>
        <div class="right-11 bottom-[-35px] absolute flex items-start py-[4px] mr-[-30px] pl-[74px]">
          <img
    ...
    <div class="bg-white w-full flex-col flex items-start px-10 pt-10 pb-[30px] rounded-[20px]">
      ...
      <div class="w-full flex justify-between items-center">
        <img
          ...
          src="/assets/new/cst--21-31-Frame24-31-Ourpartners-31-wrapper-31-03Greenenergy.png" />
        <img
          class="object-cover h-[120px] w-[176px]"
          alt="barleyeagle1-31-Frame24-31-Ourpartners-31-wrapper-31-03Greenenergy"
          src="/assets/new/barleyeagle1-31-Frame24-31-Ourpartners-31-wrapper-31-03Greenenergy.png" />
        <img
          class="object-cover h-[110px] w-[215px]"
          alt="klimatelink1-31-Frame24-31-Ourpartners-31-wrapper-31-03Greenenergy"
          src="/assets/new/klimatelink1-31-Frame24-31-Ourpartners-31-wrapper-31-03Greenenergy.png" />
        <img
          class="object-cover h-[110px] w-[139px]"
          alt="insta--11-31-Frame24-31-Ourpartners-31-wrapper-31-03Greenenergy"
          src="/assets/new/insta--11-31-Frame24-31-Ourpartners-31-wrapper-31-03Greenenergy.png" />
        <img
          class="object-cover h-[130px] w-[147px]"
