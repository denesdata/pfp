    ...
    <div class="flex-col w-full flex items-start gap-[30px]">
      <div class="w-full flex-col flex justify-center items-start gap-2.5 text-sm leading-[26px] font-PublicSans">
        <div class="flex items-center gap-2.5">
          ...
          <div class="font-semibold text-[#2e3855]">A war worth fighting</div>
        </div>
      </div>
      <div class="bg-white w-full flex-col flex items-center gap-[30px] pb-[60px] rounded-[20px]">
        <div
          class="bg-cover bg-center bg-[url('/assets/new/3.jpg')] w-full flex-col h-[300px] flex items-start p-5 rounded-t-[20px]" />
        <div class="flex-col w-5/6 flex items-center gap-5 text-[#2e3855]">
          ...
          <div class="w-full flex-col flex items-start gap-3">
            <div class="text-xl leading-[34px] font-bold font-Poppins">Action steps for individuals:</div>
            <ul class="list-disc pl-4">
              <li>As a consumer, demand brands prioritise nature in their operations</li>
              <li>As a voter, support candidates who advocate for renewable energy and reject fossil fuels</li>
              <li>As an employee, encourage business leaders to take immediate action to protect the planet</li>
              <li>As a business owner, require suppliers to demonstrate their green credentials</li>
